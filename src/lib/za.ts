...
export interface Shop {
  ...
  trial_ver?: boolean | null; // 【お試し版】(例: 60分のうち10分無料お試し)
...
const SHOP_SELECT =
  "id, owner_id, name, description, price_jpy, pay_url, is_trial, first_try, trial_ver, accepts_barter, accepts_tip, barter_slots, category, market, sold, handover, image_urls, thumb_urls, created_at, profiles!shops_owner_id_fkey(username, display_name, avatar_url), shop_comments(count)";
