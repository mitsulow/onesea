...
const SHOP_SELECT =
  "id, owner_id, name, description, price_jpy, pay_url, is_trial, accepts_barter, accepts_tip, barter_slots, category, market, sold, handover, image_urls, thumb_urls, created_at, profiles!shops_owner_id_fkey(username, display_name, avatar_url), shop_comments(count)";
