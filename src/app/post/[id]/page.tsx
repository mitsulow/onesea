    ...
    <main className="pb-10">
      ...
      <div className="px-4 pt-4">
        <div className="card">
          {editing ? (
            <div className="py-2">
              <div className="mb-1.5 text-[11px] font-bold text-[#8a7a5a]"><img src="/icons/icon-pen.webp" alt="" style={{ width: 13, height: 13, display: "inline", verticalAlign: -2.5 }} /> コトヅテを修正</div>
              <textarea
                value={editDraft}
            ...
            <>
              ...
              {me?.id === post.user_id && (
                ...
                >
                  <img src="/icons/icon-pen.webp" alt="" style={{ width: 13, height: 13, display: "inline", verticalAlign: -2.5 }} /> コトヅテを修正
                </button>
              )}
            </>
          )}
